...
TRUNCATE
    ...
    "public"."cache",
    "public"."translations",
    "specific"."worldCerealProductMetadata"
    CASCADE;
...
VALUES ('cad8ea0d-f95e-43c1-b162-0704bfc1d3f6', null, null, null, 'guest'),
       ...
       ('7c5acddd-3625-46ef-90b3-82f829afb258', 'test@noperms.example.com',
...
VALUES ('ed6a9cb0-7662-4d85-bb9a-ed5b78396008', null, 'metadata', 'cases', 'view'),
       ...
       ('55253c47-f406-4297-8a22-b4ef03200c36', null, 'metadata', 'scopes', 'create'),
       ('9df3cd8e-528d-4a7e-932e-e78ced43b0de', null, 'metadata', 'scopes', 'update'),
...
VALUES
    ...
    -- user: admin@example.com  metadata:periods:update
    ('2d069e3a-f77f-4a1f-aeda-50fd06c8c35d', '6d594989-2adb-44cc-8915-9c12dad907ba'),
    -- user: admin@example.com  metadata:periods:delete
    ('2d069e3a-f77f-4a1f-aeda-50fd06c8c35d', 'c6b86b26-a29b-4184-99c1-8bc46a5735df'),
    ...
    -- user: worldCerealUser@create-perms.com, specific:worldCerealProductMetadata:update
    ('3fdd158d-4b78-4d11-92c7-403b4adab4d8', '9c125676-996d-48a0-b973-5adda3e4e195'),
    -- user: worldCerealUser@create-perms.com, specific:worldCerealProductMetadata:delete
    ('3fdd158d-4b78-4d11-92c7-403b4adab4d8', '3754fae3-5f42-4640-98f3-022a7a4e28af'),
    -- user: worldCerealUser@create-perms.com, specific:worldCerealProductMetadata:view
